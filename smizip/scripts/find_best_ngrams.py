...
# This default list should be more explicit.
# It took me some time to understand the error "u" because I had compounds with copper (Cu).
...
def main():
    ...
    if args.speed == "slow":
        ...
        FACTOR = 1
        NUM_SMILES_TO_TEST = max(2,((NUM_LINES / ITERATIONS) / FACTOR) - ITERATIONS)
        ...
        TEST_AT_LEAST_N_SOMETIMES, SOMETIMES_INTERVAL = NUM_SMILES_TO_TEST / FACTOR, (TEST_AT_LEAST_N_MEASURED / DELTA_TO_TEST) * 2 * FACTOR
